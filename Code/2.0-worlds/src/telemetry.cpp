...
void screenTelemetry() {
    ...
    while (true) {
        ...
        // console.clear();
        // console.printf("x: %.3f    y: %.3f   theta: %.3f", pose.x, pose.y, pose.theta);
        // console.printf("Intake: act vel %d | tgt vel  %d | eff %.1f", int(intake_motor.get_actual_velocity()), int(intake_motor.get_target_velocity()), intake_motor.get_efficiency());
        // console.printf("optical: %03d %03.1f %03.1f %03d", int(optical_sensor.get_hue()), optical_sensor.get_saturation(), optical_sensor.get_brightness(), optical_sensor.get_proximity());
        // console.printf("left temp: %d %d %d", 
        //                     int(dt_left.get_temperature(0)),
        //                     int(dt_left.get_temperature(1)), 
        //                     int(dt_left.get_temperature(2)));
        // console.printf("right temp: %d %d %d",
        //                     int(dt_right.get_temperature(0)),
        //                     int(dt_right.get_temperature(1)), 
        //                     int(dt_right.get_temperature(2)));
        // console.printf("intake temp: %d", int(intake_motor.get_temperature()));
        // console.printf("arm temp: %d %d", int(arm_motors.get_temperature(0)), int(arm_motors.get_temperature(1)));
...
void telemetryInit() {
    screenImage();
    pros::Task screenTelemetryTask(screenTelemetry);
