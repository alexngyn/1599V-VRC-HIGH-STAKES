...
void autonIntake() { colorSortVision(); unjam(); pros::delay(50); }
...
lemlib::Pose awp_neg_3 = {-10, 43, 0};
lemlib::Pose awp_neg_4 = {-10,50, 0};
...
void soloAWP_left_neg(){ // red
    ...
    chassis.swingToHeading(-awp_neg_2.theta-180, DriveSide::RIGHT, 1000, {.minSpeed = 60}, false);
...
void elims_right () { // red
    ...
    doinker_solenoid.toggle();
    clamp_solenoid.toggle();   
    chassis.turnToHeading(elims_6.theta-30, 1000);
    ...
    chassis.moveToPose(elims_9.x, elims_9.y, elims_9.y, 100, {.forwards = false, .maxSpeed = 127}, false);
    arm_controller.moveToAngle(16);
    chassis.moveToPose(elims_9.x+12, elims_9.y, elims_9.y, 1000, {.forwards = false, .maxSpeed = 127}, false);
}
