...
lemlib::Pose skills_21 = offsetPose({47.035, -0, 300},-2);
...
void skills() {
    ...
    chassis.moveToPoint(skills_32.x, skills_32.y, 1000, {.forwards=true, .maxSpeed=96}, false);
