...
lemlib::Pose qual_pos_red_6 = offsetPoint({-47.244+2, -4, NAN}, qual_pos_red_5, 0);  //51
...
lemlib::Pose qual_pos_blue_0 = {64,15,142}; 
lemlib::Pose qual_pos_blue_1 = offsetPose(qual_pos_blue_0, 8);
lemlib::Pose qual_pos_blue_2 ={23.6,23.6, 60};
lemlib::Pose qual_pos_blue_3 = {23.6, 47.25, NAN};
lemlib::Pose qual_pos_blue_4 = {47, 0, NAN};
...
void qual_pos_blue() {
    ...
    chassis.moveToPoint(qual_pos_blue_1.x, qual_pos_blue_1.y, 3000, {.forwards = false}, false); //rush to mogo

    chassis.moveToPose(qual_pos_blue_2.x, qual_pos_blue_2.y, qual_pos_blue_2.theta, 30000, {.forwards = false}, false); //rush to mogo
    clamp_solenoid.retract(); //clamp mogo

    intake_controller.set(Intake::IntakeState::INTAKING);

    chassis.moveToPoint(qual_pos_blue_3.x, qual_pos_blue_3.y, 3000, {.forwards = true, .maxSpeed=64}, false); //rush to mogo

    pros::delay(300);

    intake_solenoid.extend();

    chassis.moveToPoint(qual_pos_blue_4.x, qual_pos_blue_4.y, 8000, {.forwards = true, .maxSpeed=64}, false); //rush to mogo
...
//     chassis.turnToPoint(qual_pos_blue_4.x, qual_pos_blue_4.y, 1000, {.forwards=true, .direction=lemlib::AngularDirection::CCW_COUNTERCLOCKWISE,.maxSpeed=96}, false); // turn to ring
//     clamp_solenoid.extend();
//     chassis.turnToPoint(qual_pos_blue_5.x, qual_pos_blue_5.y, 1000, {.forwards=false, .direction=lemlib::AngularDirection::CCW_COUNTERCLOCKWISE,.maxSpeed=96}, false); // turn to mogo
//     chassis.moveToPoint(qual_pos_blue_4.x, qual_pos_blue_4.y, 1000, {.forwards = false,.maxSpeed=96}, false); // go to mogo
...
//     chassis.moveToPoint(qual_pos_blue_6.x, qual_pos_blue_6.y, 1000, {.forwards = true, .maxSpeed=96}, false); // go to stake
...
//     chassis.moveToPoint(elims_pos_red_1.x, elims_pos_red_1.y, 1000, {.forwards = false}, false); //rush to mogo
//     chassis.moveToPose(elims_pos_red_2.x, elims_pos_red_2.y, elims_pos_red_2.theta, 1000, {.forwards = false}, false); //rush to mogo
//     chassis.moveToPoint(elims_pos_red_2.x, elims_pos_red_2.y, 500, {.forwards = false}, false); //rush to mogo
...
//     chassis.moveToPose(elims_pos_red_3.x, elims_pos_red_3.y, elims_pos_red_3.theta, 1000, {.forwards = true}, true);
//     intake_controller.hold(true);
...
//     intake_solenoid.extend();
//     arm_controller.moveTo(Arm::position::INTAKE);
//     chassis.turnToPoint(elims_pos_red_6.x, elims_pos_red_6.y, 1000, {}, false); // turn to stake
...
//     chassis.moveToPose(elims_pos_blue_3.x, elims_pos_blue_3.y, elims_pos_blue_3.theta, 1000, {.forwards = true}, true);
//     intake_controller.hold(true);
...
//     clamp_solenoid.extend();
//     chassis.turnToPoint(elims_pos_blue_5.x, elims_pos_blue_5.y, 1000, {.forwards=false}, false); // turn to mogo
//     chassis.moveToPoint(elims_pos_blue_4.x, elims_pos_blue_4.y, 1000, {.forwards = false,.maxSpeed=60}, false); // go to mogo
